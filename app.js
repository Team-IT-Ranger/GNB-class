...
function renderTroubleshoot() {
  ...
  ${table([["อาการ", "สาเหตุที่พบบ่อย", "ทำอย่างไร"],
    ...
    ["เพิ่มแหล่งจาก Drive ไม่ได้", "ไฟล์เป็น .xlsx (Notebook ไม่รับ Excel ตรง ๆ) หรือ .docx ที่ยังไม่แปลง หรือไม่มีสิทธิ์ไฟล์", "เปิด .xlsx เป็น Google Sheets ก่อน (หรือส่งออก CSV) เปิด .docx เป็น Google Docs หรือวางข้อความเป็นแหล่ง"],
...
function renderDataFiles() {
  ...
  <p class="lede">ชุดเอกสารสมมติของบริษัท ไร้ควันพันล้าน ทุกชื่อ ตัวเลข และเหตุการณ์ไม่ใช่ข้อมูลจริง เอกสารตั้งใจให้ไม่สมบูรณ์ ไม่สม่ำเสมอ และบางฉบับขัดกันเอง งานของคุณคือเตรียมให้พร้อมและตรวจสอบก่อนใช้ อัปโหลดเข้า Google Drive ของคุณแล้วเปิดเป็น Google Docs/Sheets (ไฟล์ .xlsx คือ 03, 05, 09: Notebook ไม่รับ Excel ตรง ๆ ต้องเปิดเป็น Google Sheets ก่อนใส่เป็นแหล่ง)</p>
